        ...
        <div class="concept">
          ...
          <div class="concept__visual reveal" data-delay="2">
            <div class="ph ph--tall">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" aria-hidden="true"><circle cx="12" cy="12" r="8"/><path d="M12 7v5l3.5 2" stroke-linecap="round"/></svg>
              <span class="ph__tag">Lifestyle-Abbildung</span>
            </div>
          </div>
        </div>
      </div>
